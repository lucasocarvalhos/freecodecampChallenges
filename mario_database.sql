...
--
-- Name: sounds fk_sounds_characters; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.sounds
    ADD CONSTRAINT fk_sounds_characters FOREIGN KEY (character_id) REFERENCES public.characters(character_id);
